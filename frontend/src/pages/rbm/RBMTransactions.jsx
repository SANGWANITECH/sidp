...
export default function RBMTransactions() {
  ...
  const loadTransactions = async () => {
    try {
      const res = await client.get('/transactions/all?limit=100')
    ...
    <div style={{ minHeight: '100vh', background: '#F4F6F9', fontFamily: 'Arial, sans-serif' }}>
      ...
      <div style={{ padding: isMobile ? '20px 16px' : '28px 24px', maxWidth: 1100, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20, flexWrap: 'wrap', gap: 12 }}>
          <div>
            <h2 style={{ fontSize: 18, fontWeight: 'bold', color: '#0D2137', margin: 0 }}>All Transactions</h2>
            <p style={{ color: '#5A6E82', fontSize: 13, margin: '4px 0 0' }}>{total} total across all institutions</p>
          </div>
